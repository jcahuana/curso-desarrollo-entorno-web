...
class KlassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create klass" do
    assert_difference('Klass.count') do
      post klasses_url, params: { klass: { credit: @klass.credit, name: @klass.name, student_id: @klass.student_id, tutor_id: @klass.tutor_id } }
    end
  ...
  test "should update klass" do
    patch klass_url(@klass), params: { klass: { credit: @klass.credit, name: @klass.name, student_id: @klass.student_id, tutor_id: @klass.tutor_id } }
