...
class AlumnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alumno" do
    assert_difference('Alumno.count') do
      post alumnos_url, params: { alumno: { dni: @alumno.dni, email: @alumno.email, email_confirmation: @alumno.email_confirmation, nombres: @alumno.nombres } }
    end
  ...
  test "should update alumno" do
    patch alumno_url(@alumno), params: { alumno: { dni: @alumno.dni, email: @alumno.email, email_confirmation: @alumno.email_confirmation, nombres: @alumno.nombres } }
